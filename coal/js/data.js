...
export async function loadData() {
  const resources = [
    { id: 'total',       label: 'COAL (TOTAL)',    fieldPrefix: 'coal',        unit: 'short tons', color: '#3D3D3D', years: d3.range(2001, 2025) },
    { id: 'surface',     label: 'SURFACE MINING',  fieldPrefix: 'surface',     unit: 'short tons', color: '#7A5C2E', years: d3.range(2001, 2025) },
    { id: 'underground', label: 'UNDERGROUND',      fieldPrefix: 'underground', unit: 'short tons', color: '#3A4A6A', years: d3.range(2001, 2025) },
  ];
